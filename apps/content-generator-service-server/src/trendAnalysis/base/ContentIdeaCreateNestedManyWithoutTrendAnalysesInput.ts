...
@InputType()
class ContentIdeaCreateNestedManyWithoutTrendAnalysesInput {
...
export { ContentIdeaCreateNestedManyWithoutTrendAnalysesInput as ContentIdeaCreateNestedManyWithoutTrendAnalysesInput };
